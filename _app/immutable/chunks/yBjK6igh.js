import{k as h,d as g,h as qn,q as Y,l as ee,m as te,n as v,o as $e,p as Xe,s as Gn,u as zn,c as Kt,t as jt,v as Kn,E as Qe,w as jn,x as $n,S as de,y as Bn,F as Ze,z as Yn,A as Jn,L as Xn,B as $t,C as Qn,G as Zn,e as Tt,H as wt,r as yt,I as ei}from"./C4c6zY-H.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke=new Xn("@firebase/auth");function ii(n,...e){ke.logLevel<=$t.WARN&&ke.warn(`Auth (${de}): ${n}`,...e)}function we(n,...e){ke.logLevel<=$t.ERROR&&ke.error(`Auth (${de}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(e,t){this.shortDelay=e,this.longDelay=t,C(t>e,"Short delay should be less than long delay!"),this.isMobile=Yn()||Jn()}get(){return ri()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function b(n,e,t=!1){if(t)return e;try{return await e}catch(i){throw i instanceof Ze&&mi(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function mi({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
