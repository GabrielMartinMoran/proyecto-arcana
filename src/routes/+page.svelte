...
<main>
	...
	<p class="lead">
		...
		habilidades, conjuros, talentos y rasgos de linaje no están encerrados en una clase, sino que
		son cartas que coleccionas y combinas para crear un héroe verdaderamente único.
	</p>
