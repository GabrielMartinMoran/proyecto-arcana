...
async function bootstrap() {
    ...
    const ensureMobileAppBar = () => {
        if (!document.getElementById('mobile-appbar')) {
            ...
            bar.innerHTML =
                '<button class="nav-toggle" id="global-open-drawer" aria-label="Abrir menú">☰</button><div class="brand">Proyecto Arcana</div>';
            ...
            if (btn)
                btn.addEventListener('click', async () => {
                    ...
                    try {
                        ...
                        const existingExtra = document.querySelector(
                            '#sidebar .sidebar-extra .sidebar-section-content'
                        );
