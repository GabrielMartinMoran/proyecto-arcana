...
Para diseñar un encuentro equilibrado, primero calcula el **Poder del Grupo**. Esta métrica evoluciona a medida que los personajes progresan.

-   **Poder de Grupo = (Poder Base) + (Modificador de Progreso)**

### Paso 1: Calcula el Poder Base

El Poder Base depende únicamente del número de jugadores.

-   **Poder Base = (Número de Jugadores) × 3**
...
> Un grupo de 4 jugadores comienza. Su **Poder Base** es 12 (4x3). Su **Modificador de Progreso** es +0. Su **Poder de Grupo total** es 12. Un encuentro "Normal" se construiría con criaturas cuyo NA sume 12.
>
> Después de varias sesiones, has otorgado 20 PP en total al grupo. Como han superado el umbral, su **Modificador de Progreso** aumenta a **+1**.
>
> Su **nuevo Poder de Grupo** es ahora 12 + 1 = 13. A partir de ahora, tus encuentros "Normales" se construirán con un presupuesto de 13 NA.
...
-   **Múltiples Cabezas:** La hidra tiene 5 cabezas. Por cada 20 de daño que la hidra recibe en un solo turno, una de sus cabezas muere. Si todas las cabezas mueren, la hidra muere.
...
-   **Asalto Múltiple:** El sacerdote puede realizar dos ataques con su Acción, usando Maza o Llama Radiante en cualquier combinación.
